  ...
  return (
    <div lang="th">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {top.length >= 4 && (
          <section className="mb-10">
            <h2 className="text-sm font-bold uppercase tracking-widest text-[var(--muted)] mb-4">เปรียบเทียบคลินิก</h2>
              ...
              {([[top[0], top[1]], [top[2], top[3]]] as [typeof top[0], typeof top[0]][]).map(([x, y]) => x && y ? (
                <a key={`${x.id}-${y.id}`} href={`/compare/${x.id}/${y.id}`}
                  ...
                  <div className="shrink-0 text-right">
                    <div className="text-[10px] text-[var(--muted)]">ความน่าเชื่อถือ</div>
