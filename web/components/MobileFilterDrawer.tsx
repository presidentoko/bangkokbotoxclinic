  ...
  return (
    <>
      <button
        ...
        className="sm:hidden inline-flex items-center gap-2 rounded-full border border-[var(--border)] bg-white px-4 py-2 text-sm font-bold shadow-sm hover:shadow"
      >
        ...
        <>
          ...
          <div role="dialog" aria-modal="true"
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
              {/* Min rating */}
              <div>
                <div className="text-xs font-black uppercase tracking-widest text-[var(--muted)] mb-2">Minimum rating</div>
              ...
              {/* Language */}
              <div>
                <div className="text-xs font-black uppercase tracking-widest text-[var(--muted)] mb-2">Staff language</div>
              ...
              {/* Sort */}
              <div>
                <div className="text-xs font-black uppercase tracking-widest text-[var(--muted)] mb-2">Sort by</div>
                <div className="grid grid-cols-2 gap-2">
                  {SORTS.map((s) => (
            ...
            <div className="border-t bg-white p-3 grid gap-2" style={{ borderColor: "var(--border)" }}>
