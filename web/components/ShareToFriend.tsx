...
export default function ShareToFriend({
  ...
  return (
    <div className="rounded-2xl border bg-white p-4 sm:p-5" style={{ borderColor: "var(--border)" }}>
      ...
      <div className="flex flex-wrap gap-2">
        <button onClick={copy}
          className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--border)] bg-white px-3 py-2 text-xs font-bold hover:bg-slate-50">
