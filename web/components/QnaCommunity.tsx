...
export default function QnaCommunity({ focus }: { focus: SiteFocus }) {
  ...
  return (
    <section className="rounded-2xl border bg-white overflow-hidden" style={{ borderColor: "var(--border)" }}>
      <div className="px-5 py-4 border-b flex items-baseline justify-between gap-3 flex-wrap" style={{ borderColor: "var(--border)" }}>
        <div>
          <div className="text-xs font-black uppercase tracking-widest text-[var(--muted)]">Community Q&amp;A</div>
          ...
          <li key={i} className="p-5">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-[10px] text-[var(--muted)] mt-0.5">Asked by {q.askedBy} · {q.ago}</div>
              </div>
            </div>
