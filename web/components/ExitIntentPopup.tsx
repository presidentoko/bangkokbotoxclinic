      ...
      <div role="dialog" aria-modal="true"
        ...
        <div className="px-6 pt-6 pb-3">
          <button onClick={() => setOpen(false)} aria-label="Close"
            className="absolute top-3 right-3 text-[var(--muted)] hover:text-black -m-1 p-1 text-xl">✕</button>
          <div className="text-5xl mb-2 text-center">⏳</div>
          {sent ? (
            <div className="text-center">
              <h3 className="text-2xl font-black mb-1">Sent — check your inbox</h3>
              <p className="text-sm text-[var(--muted)]">PDF arrives within 1 minute.</p>
            </div>
          ) : (
            <>
              <h3 className="text-2xl font-black text-center mb-2">Don&apos;t book yet — read this first</h3>
              <p className="text-sm text-[var(--muted)] text-center mb-4 leading-relaxed">
