    ...
    <section className="rounded-2xl border-2 border-rose-200 bg-rose-50 p-5">
      ...
      <ul className="grid sm:grid-cols-3 gap-3 mt-4">
        <li className="rounded-lg bg-white border border-rose-200 p-3">
          ...
          <div className="text-[10px] text-[var(--muted)]">Free national emergency line</div>
        </li>
        <li className="rounded-lg bg-white border border-rose-200 p-3">
          ...
          <div className="text-[10px] text-[var(--muted)]">English/Chinese/Korean operators</div>
        </li>
        <li className="rounded-lg bg-white border border-rose-200 p-3">
          ...
          <div className="text-[10px] text-[var(--muted)]">Reach us 9am–9pm ICT, &lt;1h reply</div>
        </li>
      </ul>
