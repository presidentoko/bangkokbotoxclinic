  ...
  return (
    <section className="rounded-2xl border-2 bg-white p-5" style={{ borderColor: status.open ? "#86efac" : "#fcd34d" }}>
      <div className="flex items-baseline justify-between gap-3 mb-3 flex-wrap">
        <div>
          <div className="text-xs font-black uppercase tracking-widest text-[var(--muted)]">Contact this clinic</div>
      ...
      <p className="text-xs text-[var(--muted)] mb-3">{status.hint}</p>
