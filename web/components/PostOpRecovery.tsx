...
export default function PostOpRecovery({ focus }: { focus: SiteFocus }) {
  ...
  return (
    <section className="rounded-2xl border bg-white p-5 sm:p-6" style={{ borderColor: "var(--border)" }}>
      <div className="mb-4">
        <div className="text-xs font-black uppercase tracking-widest text-[var(--muted)]">Recovery timeline</div>
      ...
      <div className="overflow-x-auto -mx-2 px-2">
        <table className="w-full text-xs border-separate" style={{ borderSpacing: "0 8px" }}>
          <thead>
            <tr>
              <th className="text-left font-bold uppercase text-[10px] tracking-widest text-[var(--muted)] pl-3">When</th>
              <th className="text-left font-bold uppercase text-[10px] tracking-widest text-[var(--muted)]">How you&apos;ll feel</th>
