        ...
        <div className="space-y-4">
          {steps.map((s, i) => (
            <li key={i} className="relative pl-0 sm:pl-14">
              ...
              <div className="rounded-xl bg-white border p-4" style={{ borderColor: "rgb(var(--border))" }}>
                ...
                <p className="text-sm text-[rgb(var(--muted))] leading-relaxed" dangerouslySetInnerHTML={{ __html: s.body }} />
              </div>
            </li>
          ))}
        </div>
