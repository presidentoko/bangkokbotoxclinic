    ...
    <section className="rounded-2xl border-2 border-indigo-300 bg-gradient-to-br from-indigo-50 to-blue-50 p-5 sm:p-7">
      <div className="grid sm:grid-cols-[1fr_auto] gap-5 items-center">
        <div>
          ...
          <p className="text-sm text-[rgb(var(--muted))] mb-3">{cfg.sub}</p>
        ...
        <div className="sm:w-72">
          {sent ? (
            ...
            <form onSubmit={submit} className="rounded-xl bg-white border-2 p-3" style={{ borderColor: "rgb(var(--border))" }}>
              ...
              <p className="text-[10px] text-[rgb(var(--muted))] mt-1.5 text-center">No spam. Unsubscribe anytime.</p>
            </form>
          )}
        </div>
      </div>
