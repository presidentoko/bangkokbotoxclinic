      ...
      {open && (
        <div role="dialog" aria-label="Accessibility"
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="flex gap-2">
                <button onClick={() => setFont(Math.max(80, font - 10))}
                  className="flex-1 rounded-lg border px-3 py-1.5 text-sm font-bold hover:bg-slate-50" style={{ borderColor: "rgb(var(--border))" }}>A−</button>
            ...
            <label className="flex items-center justify-between gap-2 cursor-pointer rounded-lg border bg-slate-50 px-3 py-2" style={{ borderColor: "rgb(var(--border))" }}>
