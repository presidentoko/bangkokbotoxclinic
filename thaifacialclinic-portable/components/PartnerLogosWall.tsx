...
export default function PartnerLogosWall() {
  return (
    <section className="border-y bg-slate-50 py-6" style={{ borderColor: "rgb(var(--border))" }}>
      <div className="max-w-5xl mx-auto px-4">
        <div className="text-center text-[10px] font-black uppercase tracking-widest text-[rgb(var(--muted))] mb-4">
