...
export default function InsuranceCoverageCheck() {
  ...
  return (
    <section className="rounded-2xl border bg-white p-5" style={{ borderColor: "rgb(var(--border))" }}>
      <div className="mb-3">
        <div className="text-xs font-black uppercase tracking-widest text-[rgb(var(--muted))]">Insurance quick check</div>
        <h3 className="text-base font-black mt-0.5">Does your plan cover Bangkok?</h3>
        <p className="text-xs text-[rgb(var(--muted))] mt-1">Common cover rules for international insurance providers.</p>
      </div>
