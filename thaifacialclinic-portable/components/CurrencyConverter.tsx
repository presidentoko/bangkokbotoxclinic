  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg border border-[rgb(var(--border))] bg-white px-3 py-1.5 text-xs font-bold hover:bg-slate-50"
      >
        {RATE[ccy].symbol} {ccy}
      ...
      {open && (
        <>
          ...
          <div className="absolute top-full mt-2 right-0 z-40 w-40 rounded-xl bg-white border-2 shadow-xl py-1 overflow-hidden" style={{ borderColor: "rgb(var(--border))" }}>
