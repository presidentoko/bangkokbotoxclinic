...
export default function PrivacyPage() {
  return (
    <main className="max-w-2xl mx-auto px-4 py-12 text-sm leading-relaxed text-zinc-700">
      ...
      <p className="text-xs text-zinc-400 mb-8">Last updated: June 2026 · Complies with Thailand PDPA (B.E. 2562)</p>
      ...
      <section className="mb-7">
        ...
        <ul className="list-disc list-inside space-y-1 text-zinc-600">
          ...
          <li>No third-party ad network tracking (no Google Ads, Facebook Pixel, etc.)</li>
      ...
      <section className="mb-7">
        ...
        <p className="mb-2">We use one first-party cookie/localStorage key (<code>thaigle_cookie_consent</code>) to remember your cookie preference. Vercel Analytics may set a session cookie for page-view counting.</p>
        <p>You may decline analytics via the cookie banner. Declining does not affect site functionality.</p>
      </section>

      <section className="mb-7">
        <h2 className="font-bold text-zinc-900 mb-2">5. Affiliate links & third-party services</h2>
      ...
      <section className="mb-7">
        <h2 className="font-bold text-zinc-900 mb-2">6. Data source & venue information</h2>
      ...
      <section className="mb-7">
        <h2 className="font-bold text-zinc-900 mb-2">7. Your rights (PDPA)</h2>
      ...
      <section className="mb-7">
        <h2 className="font-bold text-zinc-900 mb-2">9. Data deletion request</h2>
      ...
      <section className="mb-7">
        <h2 className="font-bold text-zinc-900 mb-2">10. Changes to this policy</h2>
