      ...
      <section className="border-b border-[var(--border)]">
        <div className="max-w-3xl mx-auto px-4 pt-12 pb-8 text-center">
          <div className="text-xs uppercase tracking-wider text-[var(--muted)] mb-3">
            日本語 · <a href="/" className="underline hover:text-[var(--fg)]">English</a> · <a href="/th" className="underline hover:text-[var(--fg)]">ภาษาไทย</a> · <a href="/ko" className="underline hover:text-[var(--fg)]">한국어</a> · <a href="/ru" className="underline hover:text-[var(--fg)]">Русский</a> · <a href="/ar" className="underline hover:text-[var(--fg)]">العربية</a>
          </div>
