const TOPICS = [
  {
    ...
    action: "Refill Station (refillstationbkk.com) for bulk product refill locations; Bangkok's zero-waste community network on Facebook (Zero Waste Thailand group); Chatuchak Weekend Market Section 4 for vintage and upcycled goods; Or Tor Kor Market for package-minimal fresh produce.",
  },
  {
