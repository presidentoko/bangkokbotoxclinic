...
export function BangkokBingo() {
  ...
  const shareResult = async () => {
    ...
    const shareUrl = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.thaigle.com"}/bingo?d=${encodeBingo(checked)}&utm_source=share&utm_medium=native&utm_campaign=bingo`;
