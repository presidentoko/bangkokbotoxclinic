const TOPICS = [
  {
    ...
    action: "Thailand Film Office (filmthailand.org) for production support; TCDC Bangkok (tcdc.or.th); Thailand Creative & Design Center events calendar; Creative Thailand magazine (TCDC publication) for Thai creative industry news; TH Creative Economy Agency (CEA) at cea.or.th.",
  },
  {
  ...
  },
  {
    ...
    action: "GMM Grammy (gmmgrammy.com) for mainstream Thai music releases; Fungjai (fungjai.com) for independent Thai music discovery; Spotify's Thai Indie playlist for current independent releases; Bangkok underground show listings: BKK Underground Instagram and Facebook; Rocket Recording for Thai alternative music releases.",
  },
];
