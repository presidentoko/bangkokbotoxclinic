const TOPICS = [
  {
    ...
    action: "UN Thailand office (th.undp.org) for development programming; Foundation for the Child Development (fcd.or.th) for child welfare; Duang Prateep Foundation (dpf.or.th) for Klong Toey community programs; Human Development Foundation (hdfthailand.org) for urban community work.",
  },
  {
