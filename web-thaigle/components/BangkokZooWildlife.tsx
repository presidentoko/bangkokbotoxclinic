const TOPICS = [
  {
    ...
    action: "Khao Kheow Open Zoo (khaokheowopenzoo.com) for ticket pricing (฿500 foreigners, ฿100 Thai nationals); car access: Bang Na Expressway to Chonburi; bus from Ekkamai bus terminal to Si Racha then local transport; Night Safari advance ticket recommended; overnight accommodation: si Racha town hotels + Pattaya is 30km further south for combine trip.",
  },
  {
