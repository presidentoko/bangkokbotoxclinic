const TOPICS = [
  ...
  },
  {
    ...
    action: "International school teaching jobs: TES (tes.com) and Search Associates for international school postings; Ajarn.com for comprehensive English teaching in Thailand resources and job board; CELTA Bangkok: British Council (britishcouncil.or.th/celta) offers CELTA courses; IH Bangkok (ihbangkok.com) also runs CELTA.",
  },
  {
