    ...
    <div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10 md:pb-14">
        <div className="flex items-center justify-between mb-5">
          ...
          <Link href={`${base}/guide`} className="text-sm text-blue-600 hover:underline font-medium">All 110+ guides →</Link>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
          {[
            ...
            { href: `${base}/for/chinese-health-checkup-bangkok`, icon: "🇨🇳", label: "Chinese / 中文" },
            { href: `${base}/for/digital-nomad-health-checkup-bangkok`, icon: "💻", label: "Digital Nomads" },
          ].map((item) => (
