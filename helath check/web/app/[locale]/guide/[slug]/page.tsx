...
const GUIDES: Record<string, Guide> = {
  ...
  "gout-treatment-bangkok": {
    ...
    relatedLinks: [
      ...
      { href: "/en/guide/anemia-iron-test-bangkok", label: "Anaemia & iron test Bangkok" },
  ...
  "anemia-iron-test-bangkok": {
    title: "Anaemia & Iron Deficiency Test Bangkok — Ferritin, CBC, Iron Panel Prices (2026)",
    description: "Ferritin ฿300–฿700, iron panel ฿600–฿1,200, CBC included in all check-up packages. Most common reason for flagged haemoglobin. Treatment ฿50–฿200/month. Walk-in, no referral.",
    intro: "Anaemia — low haemoglobin or red blood cell count — is one of the most commonly flagged results in Bangkok health check-up reports, particularly in women aged 15–49, vegetarians, and frequent blood donors. Iron deficiency is the single most common nutritional deficiency worldwide, affecting over 1 billion people. Bangkok's private hospitals offer a complete anaemia diagnostic workup in a single visit: blood draw for CBC + iron panel + ferritin, with results in 2–4 hours and English reports. Iron supplements are available over-the-counter at Bangkok pharmacies and hospital pharmacies at a fraction of Western prices.",
    sections: [
      {
        heading: "Anaemia and iron test prices in Bangkok (2026)",
        content: "Diagnostic tests for anaemia and iron status at Bangkok private hospitals:",
        list: [
          "Complete blood count (CBC): included in all Bangkok health check-up packages; ฿400–฿800 standalone — provides haemoglobin, haematocrit, red blood cell count, MCV (red cell size), MCHC; the first-line anaemia screen",
          "Serum ferritin: ฿300–฿700 — the most sensitive marker of iron stores; low ferritin = iron deficiency even before haemoglobin drops (pre-latent iron deficiency)",
          "Serum iron: ฿200–฿500 — reduced in iron deficiency; also useful to check absorption if supplementing",
          "TIBC (total iron-binding capacity): ฿200–฿500 — elevated in iron deficiency; transferrin saturation = serum iron ÷ TIBC × 100 (normal 20–50%)",
          "Iron panel (serum iron + TIBC + ferritin): ฿600–฿1,200 — complete iron assessment; the preferred single order for iron deficiency workup",
          "Reticulocyte count: ฿400–฿800 — measures new red blood cells; useful to assess bone marrow response and differentiate iron deficiency from anaemia of chronic disease",
          "Peripheral blood smear: ฿400–฿800 — microscopic red cell examination; detects thalassaemia trait, spherocytes, schistocytes",
          "Haemoglobin electrophoresis (for thalassaemia and haemoglobin variants): ฿800–฿1,500 — important in Southeast Asia where thalassaemia trait is very common (carrier rate 30–40% in Thailand)",
          "Vitamin B12 + folate (macrocytic/megaloblastic anaemia): ฿600–฿1,500 each; important for vegetarians and vegans; B12 deficiency is the second most common nutritional cause of anaemia",
          "Full anaemia workup (CBC + iron panel + B12 + folate + reticulocytes): ฿2,000–฿4,000",
        ],
      },
      {
        heading: "Understanding your anaemia result from Bangkok",
        content: "How to interpret CBC and iron results from your Bangkok check-up:",
        list: [
          "Normal haemoglobin: men 13.5–17.5 g/dL; women 12.0–15.5 g/dL — Bangkok labs flag with L (low)",
          "Mild anaemia: Hb 10.0–12.0 g/dL (women) or 10.0–13.5 g/dL (men) — most patients asymptomatic or mildly fatigued",
          "Moderate anaemia: Hb 8.0–10.0 g/dL — fatigue, exertional shortness of breath, pallor",
          "Severe anaemia: Hb <8.0 g/dL — significant symptoms; investigate urgently; transfusion considered at <7 g/dL",
          "MCV (mean corpuscular volume) helps categorise: low MCV (<80 fL) = microcytic = iron deficiency, thalassaemia, lead poisoning; normal MCV (80–100 fL) = normocytic = chronic disease, early mixed deficiency; high MCV (>100 fL) = macrocytic = B12/folate deficiency, hypothyroidism, liver disease",
          "Ferritin normal: men >30 ng/mL; women >13 ng/mL; optimal (non-deficient): >50 ng/mL; subclinical deficiency: 13–30 ng/mL; depleted stores: <13 ng/mL",
          "Bangkok tip: thalassaemia trait is extremely common among Thais and other Asians (carriers have low-normal MCV and mildly low Hb without being iron-deficient); check haemoglobin electrophoresis to differentiate before iron supplementing unnecessarily",
        ],
      },
      {
        heading: "Anaemia treatment and iron supplement costs in Bangkok",
        content: "Iron deficiency and anaemia treatment at Bangkok hospitals and pharmacies:",
        list: [
          "Ferrous sulphate 200mg (ferrous iron 65mg): ฿1–฿3 per tablet = ฿30–฿90/month — the standard first-line oral iron for iron deficiency anaemia",
          "Ferrous gluconate (gentler on stomach — less elemental iron per tablet): ฿2–฿5 per tablet",
          "Ferrous bisglycinate / chelated iron (better absorbed, fewer GI side effects): ฿5–฿20 per capsule; available at Watsons, Boots, hospital pharmacies",
          "IV iron infusion (iron sucrose or ferric carboxymaltose — for rapid correction or oral intolerance): ฿2,000–฿5,000 per infusion at Bangkok private hospitals; same-day booking possible",
          "Vitamin B12 injection (for severe B12 deficiency or malabsorption): ฿200–฿500 per injection at Bangkok hospitals or clinics",
          "Folic acid 5mg (for folate deficiency or during pregnancy): ฿1–฿3 per tablet",
          "Erythropoietin (EPO injection — for anaemia of chronic kidney disease): ฿1,500–฿4,000 per injection in Bangkok; 60–80% cheaper than in Western countries",
          "Doctor consultation (haematologist or internist for anaemia): ฿1,500–฿3,000 same-day available at Bumrungrad, Samitivej",
          "Bangkok advantage: generic iron supplements are extremely affordable — 30-day supply of ferrous sulphate costs ฿30–฿90 vs $15–$30 in the US",
        ],
      },
    ],
    faqs: [
      { q: "My Bangkok check-up shows low haemoglobin — what should I do?", a: "First, review the rest of your CBC: look at MCV (red cell size), then order ferritin + iron panel to determine the cause. Iron deficiency is the most likely cause (especially in menstruating women), but low MCV with normal or high ferritin in a Thai or Southeast Asian patient may indicate thalassaemia trait rather than iron deficiency — treating thalassaemia trait with iron supplements is unnecessary and doesn't raise haemoglobin. For mild anaemia: confirm iron deficiency with ferritin, start iron supplements if confirmed, recheck haemoglobin in 8–12 weeks. For moderate-severe anaemia (<10 g/dL): see an internist or haematologist in Bangkok (฿1,500–฿3,000) to investigate further before flying home." },
      { q: "I have iron deficiency anaemia — can I get IV iron in Bangkok?", a: "Yes — IV iron is available as a day procedure at Bangkok private hospitals. The most commonly used agents are ferric carboxymaltose (Ferinject — can correct iron deficiency in a single 15-minute infusion) and iron sucrose (multiple smaller infusions). IV iron is indicated when oral iron causes intolerable GI side effects, when haemoglobin needs rapid correction, or when absorption is impaired (e.g., bariatric surgery, coeliac disease, IBD). Cost in Bangkok: ฿2,000–฿5,000 per infusion. You may need only 1 infusion with ferric carboxymaltose to fully correct stores. Book via any Bangkok hospital's haematology or internal medicine department." },
      { q: "Can I bring iron supplements or iron tablets home from Bangkok?", a: "Yes — ferrous sulphate, ferrous gluconate, and ferrous bisglycinate are freely available at Bangkok pharmacies and hospital pharmacies without prescription. You can purchase a 1–3 month supply to take home. Generic ferrous sulphate (200mg × 30 tablets) costs ฿30–฿90 at Bangkok hospital pharmacies — approximately $1–$3, compared to $15–$30 for equivalent products in the UK or US. The iron is the same compound; generic is bioequivalent to branded products. Most countries allow you to bring personal-use quantities of non-prescription nutritional supplements through customs without restriction." },
    ],
    relatedLinks: [
      { href: "/en/guide/blood-test-price-bangkok", label: "All blood test prices Bangkok" },
      { href: "/en/guide/liver-function-test-bangkok", label: "Liver function test Bangkok" },
      { href: "/en/guide/vitamin-b12-deficiency-bangkok", label: "Vitamin B12 deficiency Bangkok" },
  ...
  "vitamin-b12-deficiency-bangkok": {
    title: "Vitamin B12 Deficiency Bangkok — Test, Injection & Supplement Prices (2026)",
    description: "Vitamin B12 blood test ฿600–฿1,200. B12 injection ฿200–฿500. Oral methylcobalamin supplement ฿50–฿200/month. Common in vegans, metformin users, over-60s. Action guide.",
    intro: "Vitamin B12 (cobalamin) deficiency is one of the most underdiagnosed nutritional deficiencies globally — and a commonly detected finding in Bangkok health check-ups, particularly among vegans, vegetarians, people over 60, those taking metformin for diabetes, and long-term users of proton pump inhibitors (omeprazole, pantoprazole). B12 deficiency can cause megaloblastic anaemia, peripheral neuropathy, and irreversible nerve damage if untreated. Bangkok's private hospitals can diagnose B12 deficiency in a single blood test and provide treatment — from oral supplements to intramuscular injections — at a fraction of Western pharmacy prices.",
    sections: [
      {
        heading: "Vitamin B12 test and related tests in Bangkok (2026)",
        content: "Diagnostic tests for B12 deficiency at Bangkok private hospitals:",
        list: [
      ...
      {
        heading: "Understanding your B12 result",
        content: "How to interpret Vitamin B12 results from your Bangkok health check-up:",
        list: [
      ...
      {
        heading: "Vitamin B12 treatment prices in Bangkok (2026)",
        content: "B12 replacement therapy at Bangkok hospitals and pharmacies:",
        list: [
  ...
  "diabetes-management-bangkok": {
    ...
    sections: [
      ...
      {
        heading: "Diabetes and prediabetes — understanding your Bangkok result",
        content: "How to interpret glucose and HbA1c results from your Bangkok health check-up:",
        list: [
      ...
      {
        heading: "Diabetes medication prices in Bangkok (2026)",
        content: "Oral and injectable diabetes medications at Bangkok hospital pharmacies and pharmacies:",
        list: [
  ...
  "bone-density-dexa-scan-bangkok": {
    ...
    description: "DEXA scan (dual-energy X-ray absorptiometry) in Bangkok: ฿2,500–฿5,000. Results same day. T-score interpretation, osteoporosis treatment options. No referral needed at Bumrungrad, Samitivej, Bangkok Hospital.",
    intro: "A DEXA scan (Dual-Energy X-Ray Absorptiometry) is the gold standard test for measuring bone density and diagnosing osteoporosis or osteopenia. It's quick (10–15 minutes), painless, and uses very low radiation. Bangkok's private hospitals offer DEXA scans at 50–75% below US and Australian private clinic prices, typically with same-day radiologist reports and physician consultation available.",
    sections: [
      {
        heading: "DEXA scan prices in Bangkok",
        content: "Bone density scan costs at Bangkok private hospitals (2026):",
        list: [
      ...
      {
        heading: "Understanding your DEXA T-score and Z-score",
        content: "How to interpret bone density results from your Bangkok DEXA scan:",
        list: [
      ...
      {
        heading: "Who should get a DEXA scan in Bangkok",
        content: "DEXA bone density screening recommendations — and who benefits most:",
        list: [
      ...
      {
        heading: "Osteoporosis treatment options available in Bangkok",
        content: "Treatment for low bone density or osteoporosis available at Bangkok hospitals:",
        list: [
  ...
  "high-cholesterol-treatment-bangkok": {
    ...
    relatedLinks: [
      ...
      { href: "/en/guide/high-blood-pressure-treatment-bangkok", label: "High blood pressure treatment Bangkok" },
  ...
  "high-blood-pressure-treatment-bangkok": {
    ...
    description: "Bangkok check-up showed hypertension? Amlodipine ฿50–฿150/month, ARB/ACE inhibitor ฿100–฿300/month. 24-hour BP monitor ฿2,000–฿3,500. Cardiologist same-day. What to do next.",
    intro: "High blood pressure (hypertension) is the most common abnormal finding on Bangkok health check-ups — found in roughly 1 in 4 adults screened. The good news: Thailand is one of the world's best places to get hypertension treated, with same-day cardiologist or internist consultations, 24-hour ambulatory blood pressure monitoring, and antihypertensive medications at 20–50% of Western prices. This guide covers what your blood pressure reading means, how to confirm it's truly elevated, and how Bangkok's treatment landscape compares to home.",
    sections: [
      {
        heading: "Understanding your Bangkok blood pressure result",
        content: "Blood pressure classification (AHA/ACC 2017 guidelines — used at Bangkok JCI hospitals):",
        list: [
      ...
      {
        heading: "Hypertension medication prices in Bangkok",
        content: "Antihypertensive medication costs at Bangkok hospital pharmacies and pharmacies (2026):",
        list: [
      ...
      {
        heading: "What to do next after a high BP Bangkok check-up result",
        content: "Step-by-step action guide for managing hypertension found at a Bangkok health check-up:",
        list: [
  ...
  "full-body-mri-bangkok": {
    title: "Full Body MRI Bangkok — Whole-Body Screening Scan Prices (2026)",
    description: "Whole-body MRI scan Bangkok: ฿18,000–฿45,000 at JCI hospitals. AI-assisted radiologist reading, same-day English report. 60–80% cheaper than UK or US. No contrast required. What it covers.",
    intro: "Whole-body MRI (WB-MRI) is the premium end of health check-up imaging — a single scan that screens multiple organ systems for tumours, vascular disease, and structural abnormalities without any radiation. Bangkok's JCI-accredited hospitals offer whole-body MRI at ฿18,000–฿45,000, compared to £3,000–£7,000 in the UK or $3,000–$8,000 in the US. Available as a standalone booking or as part of an ultra-premium executive check-up package. Results include a full radiologist's report in English within 24–48 hours.",
    sections: [
      {
        heading: "Whole-body MRI prices in Bangkok (2026)",
        content: "Full-body and multi-region MRI prices at Bangkok private hospitals:",
        list: [
      ...
      {
        heading: "What whole-body MRI scans — and what it misses",
        content: "What a WB-MRI covers in each region and its limitations:",
        list: [
      ...
      {
        heading: "Who should get a whole-body MRI in Bangkok and when?",
        content: "Indications and patient profiles for WB-MRI in Bangkok:",
        list: [
  ...
  "mens-health-checkup-bangkok": {
    ...
    relatedLinks: [
      ...
      { href: "/en/guide/health-checkup-by-age-bangkok", label: "Health checkup by age guide" },
      { href: "/en/guide/understanding-health-checkup-results", label: "Understanding your results" },
    ],
  },

  "health-checkup-by-age-bangkok": {
    title: "Health Check-Up by Age in Bangkok — What Tests at 30s, 40s, 50s, 60s+ (2026)",
    description: "Age-specific health screening guide for Bangkok: what blood tests, imaging, and screenings to get in your 30s, 40s, 50s, and 60+. Based on international guidelines. No referral needed.",
    intro: "The most common health check-up question isn't 'which hospital?' — it's 'what tests do I actually need at my age?' The answer depends on your age, sex, family history, and lifestyle. This guide outlines evidence-based health screening recommendations (aligned with USPSTF, NICE, WHO, and JSH guidelines) for each decade, adapted to what's available walk-in at Bangkok private hospitals in 2026.",
    sections: [
      {
        heading: "In your 30s — baseline and risk factor screening",
        content: "Recommended health check-up tests for adults aged 30–39:",
        list: [
      ...
      {
        heading: "In your 40s — cardiovascular, metabolic, and early cancer screens",
        content: "Recommended health check-up tests for adults aged 40–49:",
        list: [
      ...
      {
        heading: "In your 50s — expanded cancer screening and specialist checks",
        content: "Recommended health check-up tests for adults aged 50–59:",
        list: [
      ...
      {
        heading: "In your 60s and beyond — senior screening and ongoing monitoring",
        content: "Recommended health check-up tests for adults aged 60+ in Bangkok:",
        list: [
  ...
  "health-checkup-argentina-vs-thailand": {
    ...
    relatedLinks: [
      ...
      { href: "/en/guide/health-checkup-colombia-vs-thailand", label: "Colombia vs Thailand" },
  ...
  "health-checkup-colombia-vs-thailand": {
    ...
    description: "Medicina prepagada en Colombia: COP 800,000–COP 4,000,000. Bangkok JCI: ฿8,000–฿25,000 ($215–$675) — 40–60% más económico. Sin visa 30 días. Resultados mismo día. Guía en español.",
    intro: "Colombia cuenta con uno de los mejores sistemas de salud de América Latina, con aseguradoras como Sura, Sanitas, Colsanitas y Compensar. Sin embargo, las listas de espera para especialistas en el régimen contributivo (EPS) pueden extenderse semanas o meses, y los chequeos ejecutivos completos en clínicas privadas de Bogotá, Medellín o Cali cuestan entre COP 800,000 y COP 4,000,000 ($200–$1,000 USD). Bangkok, con 9 hospitales JCI acreditados y resultados el mismo día, ofrece calidad internacional al mismo precio o menor — sin visa para pasaporte colombiano (exención 30 días).",
    sections: [
      {
        heading: "Comparación de precios: Colombia vs Bangkok (2026)",
        content: "Precios orientativos en clínicas privadas colombianas de Bogotá, Medellín y Cali vs hospitales JCI de Bangkok. Tasa de cambio indicativa: COP 1 ≈ ฿0.009 (USD 1 ≈ COP 4,100 ≈ ฿37):",
        list: [
          "Gastroscopía con sedación: Colombia privada COP 600,000–COP 2,000,000; Bangkok ฿4,500–฿9,000 ($122–243) — Bangkok 30–50% más económico con sedación estándar incluida",
          "Colonoscopía: Colombia privada COP 1,000,000–COP 3,000,000; Bangkok ฿8,000–฿18,000 ($216–486) — similar; Bangkok sin lista de espera",
          "Resonancia magnética (RMN cerebro o abdomen): Colombia privada COP 700,000–COP 2,500,000; Bangkok ฿5,000–฿15,000 ($135–405) — Bangkok comparable con turno inmediato",
          "Tomografía (TAC): Colombia privada COP 500,000–COP 1,800,000; Bangkok ฿4,000–฿9,000 ($108–243) — Bangkok comparable o más económico",
          "Paquete ejecutivo completo (20–40 estudios: sangre, orina, ECG, radiografía, ecografía, marcadores tumorales, consulta médico): Colombia privada COP 800,000–COP 4,000,000; Bangkok ฿12,000–฿25,000 ($320–675) — Bangkok 40–60% más económico para paquetes completos",
          "PSA (próstata): Colombia privada COP 60,000–COP 180,000; Bangkok ฿600–฿1,200 ($16–32) — Bangkok similar o más económico",
          "Ecocardiograma: Colombia privada COP 350,000–COP 900,000; Bangkok ฿4,000–฿8,000 ($108–216) — Bangkok comparable",
          "Panel de marcadores tumorales completo (PSA, CEA, CA125, AFP, CA19-9): Colombia privada COP 500,000–COP 1,200,000; Bangkok ฿3,000–฿6,000 ($81–162) — Bangkok 40–60% más económico",
        ],
      },
      {
        heading: "EPS, medicina prepagada y las brechas del sistema colombiano",
        content: "Por qué colombianos optan por Bangkok para chequeos médicos completos:",
        list: [
          "EPS (régimen contributivo): Sura, Sanitas, Nueva EPS, Compensar — cubre consultas y estudios básicos, pero los chequeos ejecutivos completos con todos los marcadores e imágenes avanzadas requieren trámites, autorizaciones y esperas de semanas",
          "Medicina prepagada: Sura Prepagada, Colsanitas, Coomeva Medicina Prepagada, Compensar — calidad similar a Bangkok pero a precios equivalentes o más altos",
          "Esperas para especialistas: gastroenterólogo y cardiólogo con 3–8 semanas en régimen contributivo; 1–3 semanas incluso en prepagada en temporadas de alta demanda",
          "Colombianos en el exterior (EE.UU., España, Panamá, Canadá, México): sin acceso a EPS; seguro local frecuentemente no cubre preventivo completo; Bangkok es opción natural",
          "Ventaja de Bangkok: mismo día — gastroscopía + colonoscopía + panel de sangre completo + ecografía + consulta médico, todo en un solo día de 5–6 horas",
          "Acreditación JCI: Bumrungrad, Samitivej, Bangkok Hospital tienen certificación JCI — el estándar internacional más alto; la mayoría de clínicas privadas colombianas no están acreditadas JCI",
          "Sin visa: Colombia tiene acuerdo de exención de visa con Tailandia — pasaporte colombiano puede ingresar sin visa por 30 días",
        ],
      },
      {
        heading: "Guía práctica: de Colombia a Bangkok para un chequeo",
        content: "Información logística para colombianos que planean un chequeo médico en Bangkok:",
        list: [
          "Visa: Colombia tiene acuerdo de exención de visa con Tailandia — sin visa para turismo hasta 30 días; solo pasaporte válido",
          "Vuelos: Bogotá (BOG) → Bangkok (BKK): sin vuelo directo; conexiones típicas vía Miami (AA), Ciudad de México (AV+TG), Los Ángeles, Madrid (IB+TG), Lima, Dubái (EK); tiempo total 20–28 horas",
          "Medellín (MDE) o Cali (CLO): similar, conexión vía Bogotá o vuelo directo a hub de conexión",
          "Colombianos en EE.UU. o España: opciones de vuelo más frecuentes y rápidas a Bangkok (10–16 horas vía Asia)",
          "Hotel recomendado: Sukhumvit (zonas Nana, Asok, Phrom Phong) — a pie o 1–2 estaciones BTS de los hospitales principales (Bumrungrad en Soi 3 Sukhumvit, Samitivej en Sukhumvit 49)",
          "Día del chequeo: ayuno 8–12 horas, llegada 7:00–8:00 am; paquete estándar 3–5 horas; resultados ese día en PDF por correo electrónico en inglés",
          "Comida colombiana en Bangkok: Sukhumvit tiene restaurantes latinoamericanos; alternativas cercanas — comida brasileña, peruana, internacional",
          "Pago: Visa/Mastercard colombiana aceptada; verificar límites de la tarjeta para pagos internacionales; llevar algo de dólares o euros de respaldo; cajeros automáticos en aeropuerto y área de Sukhumvit",
        ],
      },
    ],
    faqs: [
      { q: "¿Los colombianos necesitan visa para Tailandia?", a: "No — Colombia tiene acuerdo de exención de visa con Tailandia. Con pasaporte colombiano válido, se puede ingresar libremente como turista por hasta 30 días, sin solicitar ningún visado previamente. Solo se necesita: pasaporte con al menos 6 meses de vigencia, tiquete de regreso, y suficiente dinero para la estadía. Este período es ampliamente suficiente para un chequeo médico (1 día) más vacaciones. No se requiere carta del hospital ni visa médica especial para chequeos preventivos de rutina." },
      { q: "¿Los resultados de Bangkok son válidos en Colombia?", a: "Sí — los hospitales JCI de Bangkok (Bumrungrad, Samitivej, Bangkok Hospital) emiten resultados completos en inglés con unidades internacionales: glucemia en mg/dL, colesterol en mg/dL, hemoglobina en g/dL — exactamente iguales a los laboratorios colombianos. Cualquier internista, cardiólogo o médico general colombiano puede interpretar directamente los resultados. Para imágenes (ecografía, TAC, RMN), solicita el CD de DICOM y el reporte del radiólogo en inglés — cualquier radiólogo colombiano puede leerlos. Puedes también pedir una traducción al español del reporte clínico si lo necesitas." },
      { q: "¿Vale la pena el viaje desde Colombia a Bangkok solo para un chequeo?", a: "Para un chequeo ejecutivo completo con endoscopías, imagen avanzada y marcadores tumorales, y si lo combinas con turismo: casi siempre sí. El chequeo en Bangkok ($320–675 USD) puede ser 40–60% más económico que el equivalente en una clínica privada de Bogotá o Medellín ($500–1,000+ USD), y la experiencia incluye resultados el mismo día sin lista de espera. Para colombianos que ya visitan Asia o que residen en EE.UU. o España, la ecuación es aún más favorable. Para solo estudios de sangre básicos, el viaje no se justifica económicamente — la ganancia real está en el paquete completo." },
    ],
    relatedLinks: [
      { href: "/en/guide/health-checkup-argentina-vs-thailand", label: "Argentina vs Thailand" },
      { href: "/en/guide/health-checkup-mexico-vs-thailand", label: "Mexico vs Thailand" },
  ...
  "health-checkup-egypt-vs-thailand": {
    title: "فحص صحي: مصر مقابل تايلاند 2026 — بانكوك للمصريين | Egypt vs Thailand Health Check-Up",
    description: "الفحص الشامل في القاهرة: 15,000–60,000 جنيه. بانكوك: ฿8,000–฿25,000 (8,000–25,000 جنيه) — نفس الجودة، أقل انتظاراً. مستشفيات معتمدة JCI. لا تأشيرة للمصريين.",
    intro: "يعاني نظام الرعاية الصحية في مصر من ضغط متزايد على المستشفيات الحكومية مع ارتفاع حاد في أسعار الخدمات الصحية الخاصة. أسعار الفحص الصحي الشامل في القطاع الخاص المصري وصلت إلى مستويات غير مسبوقة، بينما تقدم بانكوك — وهي وجهة طبية عالمية معترف بها — نفس الجودة في مستشفيات معتمدة دولياً (JCI) بأسعار تنافسية مع مواعيد فورية. هذا الدليل مخصص للمريض المصري الذي يفكر في السفر إلى تايلاند للفحص الطبي. / Egypt's private healthcare sector has seen rapid price increases. This guide is for Egyptian patients considering Bangkok for a health check-up.",
    sections: [
      {
        heading: "مقارنة الأسعار: القاهرة مقابل بانكوك (2026)",
        content: "مقارنة أسعار الفحوصات الطبية في المستشفيات الخاصة المصرية مقابل مستشفيات بانكوك المعتمدة (JCI):",
        list: [
          "التنظير المعدي (gastroskopia): القاهرة خاص 3,000–8,000 جنيه (80–215 دولار)؛ بانكوك 4,500–8,000 بات (125–220 دولار) — أسعار متقاربة + تخدير شامل في بانكوك",
          "تنظير القولون: القاهرة خاص 5,000–15,000 جنيه؛ بانكوك 8,000–18,000 بات — مماثلة أو أرخص قليلاً في بانكوك",
          "التصوير بالرنين المغناطيسي (MRI): القاهرة خاص 4,000–15,000 جنيه؛ بانكوك 5,000–15,000 بات — متقاربة لكن مواعيد بانكوك أسرع بكثير",
          "الماموجرام (mammogram): القاهرة خاص 500–2,000 جنيه؛ بانكوك 1,500–3,000 بات — مماثلة أو قليلاً أعلى في بانكوك",
          "الباقة التنفيذية الشاملة Executive (30–40 فحص: دم، بول، EKG، أشعة، موجات فوق صوتية، ورم خبيث): القاهرة خاص 15,000–60,000 جنيه؛ بانكوك 12,000–25,000 بات (8,700–18,000 جنيه بسعر الصرف 2026) — وفر 30–55%",
          "اختبار PSA (البروستاتا): القاهرة 300–1,000 جنيه؛ بانكوك 600–1,200 بات — مماثلة",
          "موجات فوق صوتية للبطن (ultrasound): القاهرة 500–2,000 جنيه؛ بانكوك 1,500–3,000 بات — بانكوك أغلى نسبياً لكن جودة أعلى مع تقرير إنجليزي",
          "ملاحظة: ضعف الجنيه المصري أمام الدولار يجعل سعر الصرف متغيراً — احسب بالدولار الأمريكي للمقارنة الدقيقة",
        ],
      },
      {
        heading: "ثغرات التأمين الصحي المصري وانتظار المستشفيات الحكومية",
        content: "لماذا يفكر المصريون في بانكوك للفحص الطبي:",
        list: [
          "التأمين الصحي الشامل (الحكومي): يغطي العلاج لكن ليس الفحص الوقائي الشامل؛ مواعيد شهور خاصة للأشعة المتقدمة والتنظير",
          "التأمين الصحي الخاص المصري: تغطي الشركات كـ Allianz Egypt وCareplus و MetLife بعض الفحوصات لكن الباقات التنفيذية الشاملة نادراً ما تُغطى كاملاً",
          "مستشفيات القاهرة الخاصة (Cleopatra, As-Salam, Dar Al Fouad): جودة عالية لكن ضغط على المواعيد؛ انتظار أسابيع للفحوصات المتقدمة",
          "الميزة الرئيسية لبانكوك: موعد الغد أو بعد يومين في أي مستشفى JCI؛ نتائج نفس اليوم؛ تقارير إنجليزية قابلة للاستخدام دولياً",
          "الأطباء المصريون في بانكوك: Bumrungrad تخدم مرضى عرب بشكل منتظم؛ طاقم ناطق بالعربية متاح؛ طعام حلال بالطلب",
        ],
      },
      {
        heading: "دليل عملي: من مصر إلى بانكوك للفحص الطبي",
        content: "تفاصيل رحلة الفحص الطبي من مصر إلى بانكوك:",
        list: [
          "التأشيرة: جواز السفر المصري يحتاج تأشيرة تايلاندية — يمكن الحصول عليها مسبقاً من السفارة التايلاندية في القاهرة أو عبر e-Visa (35 دولار، يُعالج في 3–5 أيام عمل)؛ الدخول 30 يوماً",
          "رحلة الطيران: القاهرة (CAI) → بانكوك (BKK): الرحلات المباشرة نادرة؛ العبور عبر دبي (EK/FZ)، الدوحة (QR)، أو طيران ناس عبر الرياض؛ إجمالي السفر 9–14 ساعة",
          "تكلفة الرحلة ذهاباً وإياباً: 600–1,500 دولار حسب الموسم والخط الجوي",
          "السكن: منطقة سوخومفيت (BTS Nana إلى Phrom Phong) قريبة من Bumrungrad و Samitivej؛ فنادق 3–5 نجوم بأسعار جيدة",
          "يوم الفحص: الوصول صائماً (8–12 ساعة) الساعة 7:00–8:00 صباحاً؛ الباقة الشاملة تستغرق 3–4 ساعات؛ نتائج نفس اليوم عبر PDF أو بريد إلكتروني",
          "خدمات اللغة العربية: Bumrungrad يمتلك قسم المريض الدولي مع موظفين ناطقين بالعربية؛ طلب مترجم عند الحجز",
          "المدفوعات: بطاقة فيزا/ماستركارد مقبولة في جميع المستشفيات؛ تحويل بنكي ممكن للمبالغ الكبيرة",
        ],
      },
    ],
    faqs: [
      { q: "هل يحتاج المصريون تأشيرة لتايلاند؟", a: "نعم — جواز السفر المصري يتطلب تأشيرة تايلاندية. يمكن التقديم عبر e-Visa التايلاندية الإلكترونية (evisa.thaigov.go.th) بتكلفة 35 دولاراً وتُعالج في 3–5 أيام عمل؛ أو من خلال السفارة التايلاندية في القاهرة شخصياً. يُمنح دخول 30 يوماً وهو أكثر من كافٍ للفحص الطبي وأيام استرداد إضافية. خطط مسبقاً قبل أسبوعين على الأقل." },
      { q: "هل المستشفيات في بانكوك آمنة للمرضى المسلمين المصريين؟", a: "نعم — تقدم مستشفيات بانكوك الكبرى احترافاً تاماً لمتطلبات المرضى المسلمين. Bumrungrad International لديه غرفة صلاة مخصصة وفريق ناطق بالعربية وطعام حلال بالطلب. أغلب المستشفيات الكبرى في بانكوك تخدم المرضى العرب بانتظام وتفهم الاحتياجات الثقافية والدينية. تايلاند بلد بوذي ذو تسامح ديني عالٍ." },
      { q: "هل يستحق السفر من مصر إلى بانكوك للفحص الطبي؟", a: "للباقة التنفيذية الشاملة مع تنظير معدي وتنظير قولون وصور متقدمة وفحوص الأورام: غالباً نعم. الوفر على الباقة (30–55%) قد يعوض تكلفة التذكرة. المزايا الإضافية: مواعيد فورية، نتائج نفس اليوم، بيئة أهدأ وتقارير إنجليزية دولية. لفحصات أساسية كتحاليل الدم فقط — الحساب أقل جدوى. الأنسب لمن يخطط لزيارة تايلاند أصلاً أو يبحث عن فحص شامل لمرة واحدة بعيداً عن ضغوط الانتظار." },
    ],
    relatedLinks: [
      { href: "/en/guide/best-hospitals-arabic-speakers", label: "دليل المستشفيات للعرب / Arabic speaker guide" },
      { href: "/en/guide/health-checkup-uae-vs-thailand", label: "UAE vs Thailand comparison" },
      { href: "/en/guide/bumrungrad-hospital-health-checkup", label: "Bumrungrad International guide" },
      { href: "/en/guide/jci-hospitals-bangkok", label: "JCI hospitals Bangkok" },
    ],
  },
  ...
  "health-checkup-south-korea-vs-thailand": {
    ...
    relatedLinks: [
      ...
      { href: "/en/guide/jci-hospitals-bangkok", label: "JCI hospitals in Bangkok" },
      { href: "/en/guide/executive-health-checkup-bangkok", label: "Executive packages guide" },
      { href: "/en/guide/health-checkup-taiwan-vs-thailand", label: "Taiwan vs Thailand" },
  ...
  "health-checkup-taiwan-vs-thailand": {
    ...
    description: "台灣自費健檢 NT$8,000–NT$50,000。曼谷 JCI 醫院 ฿8,000–฿25,000（約 NT$7,500–NT$23,500），節省 40–60%。免簽 30 天。中文服務完善。全攻略。",
    intro: "台灣擁有全球公認最完善的全民健康保險（NHI），基本醫療幾乎全免費。然而，預防性健康檢查——特別是企業高階主管套餐、全套腫瘤指標、胃鏡腸鏡合做、高解析度 MRI——仍需大量自費。台灣私人健診中心（如聯安、美兆、台安健檢）收費 NT$8,000 至 NT$50,000 以上，高階套餐甚至需等候數週。曼谷 JCI 認證醫院（Bumrungrad、Samitivej）同等級或更全面的健檢費用為 ฿8,000–฿25,000（約 NT$7,500–NT$23,500），節省 40–60%，且中文服務完善、當日取得報告。台灣每年赴泰旅客超過 100 萬人次，選擇附帶健康檢查的旅遊行程已成為一種趨勢。",
    sections: [
      {
        heading: "台灣 vs 曼谷 健檢費用比較（2026）",
        content: "主要健診項目費用對比。匯率參考：NT$1 ≈ ฿1.07：",
        list: [
          "基礎抽血（血糖、血脂、肝腎功能、甲狀腺 TSH）— 台灣自費診所 NT$3,000–NT$8,000 | 曼谷 ฿2,500–฿5,000（NT$2,340–NT$4,680）| 節省 30–50%",
          "標準健檢套餐（血液 + ECG + 胸腔 X 光 + 腹部超音波）— 台灣 NT$8,000–NT$18,000 | 曼谷 ฿5,000–฿9,000（NT$4,680–NT$8,430）| 節省 40–55%",
          "高階主管套餐（全套腫瘤指標 + CT + 醫師諮詢）— 台灣 NT$20,000–NT$50,000 | 曼谷 ฿12,000–฿25,000（NT$11,240–NT$23,400）| 節省 40–60%",
          "胃鏡（上消化道內視鏡）— 台灣自費 NT$5,000–NT$12,000；NHI 僅部分補助需有症狀 | 曼谷 ฿4,500–฿9,000（NT$4,200–NT$8,430）| 節省 30–50%",
          "大腸鏡（含靜脈麻醉）— 台灣自費 NT$10,000–NT$25,000 | 曼谷 ฿8,000–฿18,000（NT$7,500–NT$16,850）| 節省 30–50%",
          "腦部 MRI — 台灣自費 NT$6,000–NT$15,000（NHI 需轉介且等候 1–3 個月）| 曼谷 ฿5,000–฿12,000（NT$4,680–NT$11,240）| 節省 25–50%",
          "心臟冠狀動脈鈣化積分 CT（CAC）— 台灣自費 NT$5,000–NT$10,000 | 曼谷 ฿4,000–฿8,000（NT$3,750–NT$7,500）| 節省 25–40%",
          "總結：台灣 NHI 涵蓋基本醫療，但預防性精密健檢仍需自費，且知名健診中心（聯安、美兆）常需等候 2–8 週；曼谷可在 1–3 天內完成同等級甚至更全面的檢查，費用節省 40–60%",
        ],
      },
      {
        heading: "台灣 NHI 健保 vs 自費健檢 vs 曼谷健診",
        content: "台灣健保、自費健診與曼谷的差異：",
        list: [
          "台灣 NHI 成人預防保健：40–64 歲每 3 年一次免費「成人預防保健服務」（含血糖、血脂、腎功能、B/C 肝炎篩檢）；65 歲以上每年一次 — 此為基礎篩檢，不含精密影像或腫瘤指標",
          "政府補助大腸癌篩檢：50–74 歲兩年一次糞便潛血（FOBT）免費；陽性才轉介大腸鏡，等候時間不定",
          "子宮頸癌、乳癌篩檢：NHI 補助定期篩檢，但等候時間視各院安排",
          "精密健診自費市場：聯安、美兆、台安、慈濟等知名健診中心提供全套精密健檢，但高人氣中心預約時間長達 2–8 週，且高階套餐費用 NT$20,000–NT$50,000",
          "曼谷優勢：JCI 認證醫院（Bumrungrad、Samitivej）可在 1–3 天內完成含胃鏡、大腸鏡、腫瘤指標、MRI 的全套健檢；中文服務完善；英文報告（部分備有中文版）當日交付",
          "C 型肝炎（HCV）：台灣 HCV 盛行率全球較高（約 3–4%），NHI 有篩檢補助，但曼谷也可自費完整篩檢 ฿300–฿800（NT$280–NT$750）——可加入健診套餐",
          "B 型肝炎（HBV）：台灣 HBV 帶原率高，曼谷的 FibroScan 肝臟硬度掃描（฿3,000–฿6,000）是追蹤肝纖維化的好選項，台灣自費費用較高",
        ],
      },
      {
        heading: "台灣旅客前往曼谷健檢實用資訊",
        content: "簽證、交通與健檢行程安排：",
        list: [
          "簽證：台灣護照持有人赴泰免簽 30 天，無需事先辦理——直接持台灣護照入境蘇凡納布機場即可",
          "飛行時間：台北（桃園 TPE）飛曼谷（BKK）約 3.5–4 小時；有中華航空、長榮、泰航、泰獅航、亞航等多個航班選擇",
          "費用估算：台北→曼谷來回機票約 NT$6,000–NT$15,000（視淡旺季）；健診費用 NT$7,500–NT$23,500；住宿 Sukhumvit 區 NT$2,000–NT$6,000/晚 — 含機票的健診總費用仍常低於台灣高階健診中心",
          "推薦醫院：Bumrungrad International（素坤逸 Soi 3）、Samitivej Sukhumvit（素坤逸 Soi 49）、Bangkok Hospital（新碰汶里）— 均有 JCI 認證，提供中文服務或中文協調員",
          "中文服務：Bumrungrad 設有中文國際病患服務；Samitivej 備有中文翻譯員；報告提供英文版（可自行翻譯或於台灣請譯）",
          "健診日建議：前晚 10 時起禁食（可喝水），早上 7–8 時到院，Executive 套餐約 3–5 小時完成，下午即可領取結果",
          "付款：台灣 Visa/Mastercard 信用卡在曼谷大型醫院可用；建議帶國際提款卡以備不時之需",
        ],
      },
    ],
    faqs: [
      { q: "台灣人去曼谷健檢需要簽證嗎？", a: "不需要。台灣護照持有人享有泰國落地免簽（Visa Exemption），可停留 30 天，無需事先申請任何簽證。到達蘇凡納布機場後，直接前往入境審查通道，出示台灣護照、回程機票及少量財力證明（如信用卡）即可通關。如需延長至 60 天，可在泰國境內移民局辦理延簽。" },
      { q: "曼谷醫院的健檢報告，台灣醫師看得懂嗎？", a: "完全沒問題。Bumrungrad、Samitivej 等曼谷 JCI 醫院健檢報告以英文撰寫，採用 SI 國際單位（血糖 mmol/L 或 mg/dL、血脂 mmol/L、血紅素 g/dL 等），台灣醫師可直接判讀。如需影像（MRI、CT、超音波），請要求索取 DICOM 光碟——台灣放射科醫師可在 PACS 系統直接閱覽。帶回原始報告給台灣家庭醫師或內科醫師做後續追蹤是標準做法，完全可行。" },
      { q: "台灣 NHI 健保能不能給付在泰國的醫療費用？", a: "不能。台灣全民健保僅給付在台灣的醫療費用，海外自費醫療不在給付範圍內，即使在 JCI 認證醫院亦然。因此在曼谷的健診費用需完全自費。但如您有商業旅遊醫療保險，部分保單（如兆豐、富邦旅遊平安險）在境外就醫可申請理賠——請出發前確認保單條款。在曼谷健診的費用通常比台灣自費健診省 40–60%，即使不能報保險，整體仍划算。" },
    ],
    relatedLinks: [
      { href: "/en/guide/health-checkup-japan-vs-thailand", label: "Japan vs Thailand (Ningen Dock)" },
      { href: "/en/guide/health-checkup-south-korea-vs-thailand", label: "South Korea vs Thailand (한국어)" },
      { href: "/en/guide/best-hospitals-chinese-speakers", label: "Chinese-language hospitals Bangkok" },
      { href: "/en/guide/gastroscopy-cost-bangkok", label: "Gastroscopy (胃鏡) cost Bangkok" },
      { href: "/en/guide/executive-health-checkup-bangkok", label: "Executive packages Bangkok" },
    ],
  },
  ...
  "bnh-hospital-health-checkup": {
    ...
    relatedLinks: [
      ...
      { href: "/en/guide/phyathai-hospital-health-checkup", label: "Phyathai Hospital guide" },
  ...
  "phyathai-hospital-health-checkup": {
    ...
    description: "Phyathai Hospital network Bangkok: Phyathai 1, 2, and 3. Budget-friendly private check-ups from ฿2,500. Shorter waits than JCI hospitals. Preferred by Bangkok residents and budget-conscious expats.",
    intro: "Phyathai Hospital is one of Bangkok's most established private hospital networks — with three Bangkok locations (Phyathai 1 in Ratchathewi, Phyathai 2 in Din Daeng, Phyathai 3 in Lachasilla/Lat Phrao) and additional regional hospitals under the Bangkok Chain Hospital group. While less internationally marketed than Bumrungrad or Samitivej, Phyathai is extremely popular with Bangkok residents, middle-class Thais, and budget-conscious expats who want private hospital quality at closer-to-government-hospital pricing. Health check-up packages are typically 20–40% cheaper than equivalent packages at BDMS or Bumrungrad properties.",
    sections: [
      {
        heading: "Phyathai Hospital health check-up packages and prices",
        content: "Approximate health check-up package tiers at Phyathai 1, 2, and 3 Bangkok (2026):",
        list: [
          "Basic (CBC, glucose, lipids, liver + kidney function, urinalysis): ฿2,500–฿4,500 — substantially cheaper than equivalent Bumrungrad or Samitivej basic packages",
          "Standard (+ ECG, chest X-ray, abdominal ultrasound, thyroid TSH, Hep B/C, urine culture): ฿4,500–฿8,000",
          "Executive (+ CA-125, CA19-9, PSA or Pap smear, CT coronary calcium score option, cardiologist consultation): ฿8,000–฿18,000",
          "Women's package (CBC, pelvic/breast ultrasound, mammogram, CA-125, PAP smear, thyroid, Hep B/C): ฿6,000–฿12,000",
          "Cancer screening add-ons: AFP (liver), CEA (colon), CA19-9 (pancreas), PSA (prostate) — ฿400–฿800 each; can add individually to any package",
          "Price advantage: Phyathai packages are typically ฿2,000–฿8,000 cheaper than equivalent Bumrungrad/Samitivej packages for comparable tests",
        ],
      },
      {
        heading: "Phyathai vs Bumrungrad / Samitivej — which to choose?",
        content: "How Phyathai compares to Bangkok's major JCI hospitals for health check-ups:",
        list: [
          "JCI accreditation: Phyathai 2 holds JCI accreditation; Phyathai 1 and 3 are not JCI-accredited but hold Thai HA (Hospital Accreditation) and ISO certification",
          "Price: Phyathai is typically 25–40% cheaper than Bumrungrad or Samitivej for equivalent blood test panels — the main reason Bangkok residents and long-term expats choose it",
          "Waiting time: generally shorter than Bumrungrad (which processes 500,000+ international patients/year) — Phyathai 2 in particular has relatively smooth check-up logistics",
          "International patient desk: available at all three Bangkok locations but smaller than Bumrungrad's; English-speaking staff available; translation services more limited than at top JCI hospitals",
          "Imaging quality: modern CT and MRI equipment at all locations; not as heavily upgraded as Bumrungrad's 3T MRI but adequate for all standard check-up imaging",
          "Lab speed: results typically within 3–4 hours for standard panels (similar to other Bangkok private hospitals)",
          "Choose Phyathai if: you live in Bangkok and want a no-frills quality check-up at a fair price; if you're fluent in Thai; if you're budget-focused",
          "Choose Bumrungrad/Samitivej if: this is a once-a-year trip, you want the widest package variety, multiple languages, or the JCI international recognition on your report",
        ],
      },
      {
        heading: "Booking a health check-up at Phyathai Hospital",
        content: "Practical guide to booking and attending a Phyathai Hospital health check-up:",
        list: [
          "Phyathai 1 location: 364/1 Si Ayutthaya Road, Ratchathewi, Bangkok — 5 min walk from BTS Phaya Thai; also near Suvarnabhumi Airport Express",
          "Phyathai 2 location: 943 Phahon Yothin Road, Phaya Thai, Bangkok — near BTS Ari; the best-equipped of the three for health check-ups",
          "Phyathai 3 location: 111 Soi Chokechai 4 (Chokchai 4), Lat Phrao — accessible by car/taxi; good choice for residents of eastern Bangkok",
          "Online booking: Phyathai's website and call center allow advance appointment booking; English booking available by phone (+66 2-617-2444)",
          "Check-up start time: packages typically start 7:00–8:00 AM; arrive with 8–12 hours fasting for blood draws",
          "Duration: 3–4 hours for standard package; same-day results; doctor consultation included at the end",
          "Parking: all three Bangkok Phyathai locations have onsite parking or nearby public parking; daily fee typically ฿30–฿50",
          "Package add-ons: ask specifically about cancer markers, allergy panel, fertility tests, or specialist consultations — all available as pay-per-test at check-up centres",
        ],
      },
    ],
    faqs: [
      { q: "Is Phyathai Hospital safe and reliable for health check-ups?", a: "Yes. Phyathai is a well-established, reputable Thai private hospital network with decades of history. Phyathai 2 holds JCI accreditation; all three Bangkok locations hold Thai HA (Hospital Accreditation) and use ISO-certified laboratories. Many Bangkok residents, including healthcare professionals, choose Phyathai for their personal annual check-ups because it delivers solid quality at a fair price without the premium marketing overhead of Bumrungrad or the international branding of Samitivej. If your check-up is for a routine annual screen and you don't require an English-only environment, Phyathai is an excellent choice." },
      { q: "How much cheaper is Phyathai compared to Bumrungrad for a health check-up?", a: "A Phyathai standard check-up (CBC, metabolic, ECG, ultrasound, thyroid, Hep B/C) runs approximately ฿4,500–฿8,000. An equivalent package at Bumrungrad would be approximately ฿8,000–฿14,000. At the executive tier, Phyathai at ฿8,000–฿18,000 compares to Bumrungrad at ฿20,000–฿50,000+. The savings on basic and standard packages are substantial (30–45%); at the high-end executive tier with specialist consultations and advanced imaging, the gap narrows but Phyathai is still meaningfully cheaper." },
      { q: "Does Phyathai Hospital cater to English-speaking patients?", a: "English-speaking patients can be served at all three Bangkok Phyathai locations, but the experience differs from Bumrungrad or Samitivej where English-first infrastructure is a core offering. Phyathai's international patient coordinators speak English, and the main paperwork and results are available in English. However, the check-up waiting area, announcements, and some nursing staff interactions will be predominantly in Thai. This is comfortable for Bangkok residents and intermediate travelers, but may be less convenient for first-time visitors who need full English navigation throughout." },
    ],
    relatedLinks: [
      { href: "/en/guide/bumrungrad-hospital-health-checkup", label: "Bumrungrad Hospital guide" },
      { href: "/en/guide/samitivej-hospital-health-checkup", label: "Samitivej Hospital guide" },
  ...
  "samitivej-hospital-health-checkup": {
    ...
    intro: "Samitivej Hospital Sukhumvit (Sukhumvit Soi 49) is consistently ranked as one of Bangkok's top hospitals for international health check-ups — and often the preferred choice over Bumrungrad for visitors who want a high-standard, English-language JCI experience with less crowding, slightly lower prices, and a more personal atmosphere. Samitivej is part of the BDMS (Bangkok Dusit Medical Services) group, along with Bangkok Hospital. It has dedicated Japanese and Korean patient programmes and is popular with resident expats. Samitivej handles approximately 250,000 international patients per year.",
    sections: [
      {
        heading: "Samitivej health check-up packages and prices",
        content: "Health check-up package tiers at Samitivej Sukhumvit (2026 pricing):",
        list: [
          "Basic check-up (CBC, metabolic panel, glucose, cholesterol, urinalysis): ฿3,500–฿6,000",
          "Standard (+ ECG, chest X-ray, abdominal ultrasound, thyroid TSH): ฿6,000–฿11,000",
          "Comprehensive (+ cancer markers CEA, CA125/PSA, AFP, hepatitis screening): ฿11,000–฿18,000",
          "Executive (+ bone density, full cancer panel, physician specialist consultation): ฿15,000–฿30,000",
          "Premier Executive (+ MRI brain or CT coronary, cardiac specialist): ฿30,000–฿60,000",
          "Women's Health Package (+ mammogram, pap smear, HPV, pelvic ultrasound): ฿8,000–฿20,000",
          "Japanese Ningen Dock equivalent (adapted to Japanese health screening standards): ฿10,000–฿25,000; Japanese coordinator available",
          "Note: Samitivej prices are typically 10–25% lower than Bumrungrad equivalents for similar scope",
        ],
      },
      {
        heading: "Samitivej vs Bumrungrad — key differences",
        content: "How Samitivej and Bumrungrad compare for health check-up visitors:",
        list: [
          "Patient volume: Bumrungrad sees 1.3M+ patients/year; Samitivej sees ~600,000 — both big, but Samitivej feels quieter, shorter queues for check-up stations",
          "Price: Samitivej is typically 10–25% lower than Bumrungrad for equivalent packages; executive package at Bumrungrad ฿18,000+ vs Samitivej ฿13,000–฿16,000",
          "Atmosphere: Samitivej has a slightly more Thai/Asian aesthetic; Bumrungrad's lobby is 5-star hotel level — both excellent, different feel",
          "Location: Bumrungrad on Sukhumvit Soi 3 (near BTS Nana); Samitivej on Sukhumvit Soi 49 (near BTS Phrom Phong/Thong Lo) — both convenient",
          "Japanese services: BNH has the longest Japanese programme history, but Samitivej has strong Japanese coordinator team and high Japanese patient volume",
          "Korean services: Samitivej is highly rated by Korean visitors alongside Vejthani; Korean coordinator available",
          "Women's health: Samitivej has a strong obstetrics and gynaecology department — popular for women's check-ups and mammography",
          "For executives/families: Samitivej offers family packages and is a popular long-term hospital for Bangkok expat families",
          "Specialist follow-up: Bumrungrad has a slight edge in specialist breadth for rare conditions; Samitivej covers all common specialties well",
        ],
      },
      {
        heading: "How to book a health check-up at Samitivej Bangkok",
        content: "Practical booking and preparation guide for Samitivej Sukhumvit:",
        list: [
          "Online booking: samitivejhospitals.com — international health check-up packages can be booked online or via the international patient centre email",
          "By phone: call the international health check-up desk to discuss which package suits your age, sex, and health history",
          "Walk-in: walk-ins are accepted for morning check-up slots (7–8 AM) but these fill quickly; advance booking of 2–3 days recommended",
          "Fasting: standard 8–10 hours fasting from midnight before a morning appointment; water and regular medications (without food) are typically allowed — confirm with hospital",
          "Arrival: check in at the international patient desk or health check-up centre on the 3rd or 4th floor; they will coordinate all your stations",
          "Duration: standard comprehensive package 3–4 hours; executive 4–6 hours; MRI-included packages most of the morning",
          "Results: most results available 2–4 hours after last test; physician consultation included — in English, with translator available for Japanese/Korean",
          "Getting there: BTS Phrom Phong station (Sukhumvit line), 5-minute walk; taxi from Sukhumvit hotels 10–20 minutes depending on traffic",
        ],
      },
    ],
    faqs: [
      { q: "Is Samitivej or Bumrungrad better for health check-ups?", a: "Both are excellent — it depends on what you value. Samitivej is typically 10–25% cheaper for equivalent packages, has shorter queues, and slightly more personal service. Bumrungrad is more internationally known, has a wider network of specialist departments, and its international infrastructure (40+ languages, 190 nationalities served) is unmatched. For most routine health check-up visitors, Samitivej offers a better value-for-money experience. For rare specialist needs or if you specifically want the most internationally recognisable name, Bumrungrad is the choice." },
      { q: "What is Samitivej health check-up centre?", a: "Samitivej Health Check-Up Centre is the dedicated screening department at Samitivej Sukhumvit Hospital. It operates semi-independently from the general OPD — you register specifically for the health check-up programme, then move through dedicated stations (blood draw, ECG, X-ray, ultrasound, physical exam, doctor consultation) in a structured order. The centre offers comprehensive packages from ฿6,000 to ฿60,000+ depending on scope, with English and Japanese coordination." },
      { q: "Does Samitivej Sukhumvit have MRI for health check-ups?", a: "Yes — Samitivej has 1.5T and 3T MRI machines available for health check-up add-ons. MRI brain, MRI abdomen, or MRI whole body can be added to any base package. Whole-body MRI specifically is available through the premier executive packages or as a standalone add-on (฿18,000–฿45,000 depending on body area). Book the MRI when confirming your package, as these slots fill quickly in peak season." },
    ],
    relatedLinks: [
      { href: "/en/guide/bumrungrad-vs-samitivej-health-checkup", label: "Bumrungrad vs Samitivej detailed comparison" },
      { href: "/en/guide/bnh-hospital-health-checkup", label: "BNH Hospital guide" },
      { href: "/en/guide/vejthani-hospital-health-checkup", label: "Vejthani Hospital guide" },
      { href: "/en/guide/jci-hospitals-bangkok", label: "All JCI hospitals Bangkok" },
      { href: "/en/compare", label: "Compare executive packages" },
  ...
  "kidney-function-test-bangkok": {
    ...
    sections: [
      ...
      {
        heading: "Understanding kidney function test results from Bangkok",
        content: "How to interpret your Bangkok renal panel results (KDIGO 2012 CKD classification):",
        list: [
      ...
      {
        heading: "Who should get a kidney function test in Bangkok — and when?",
        content: "Who is at risk and when to test:",
        list: [
  ...
  "liver-function-test-bangkok": {
    ...
    description: "Liver function tests Bangkok: ALT/AST ฿200–฿500 each, full LFT panel ฿800–฿2,000, GGT ฿200–฿400. Fatty liver, hepatitis, alcohol liver — what your results mean + when to follow up.",
    intro: "Liver function tests (LFTs) are the most commonly flagged group of results in Bangkok executive health check-ups — particularly ALT (SGPT) elevation, which is seen in up to 30–40% of check-up patients due to the high prevalence of fatty liver disease (NAFLD) in Thailand and among visitors. Bangkok's private hospitals run the full liver enzyme panel with results in 2–4 hours, without a referral, at walk-in prices. This guide covers what each test measures, what abnormal results mean, and what to do about them.",
    sections: [
      {
        heading: "Liver function test prices in Bangkok (2026)",
        content: "Liver test prices at Bangkok private hospitals:",
        list: [
      ...
      {
        heading: "Understanding abnormal liver test results from Bangkok",
        content: "What flagged liver enzyme results mean and how to interpret them:",
        list: [
      ...
      {
        heading: "Liver health action plan — what to do after Bangkok check-up",
        content: "Steps to take based on your Bangkok liver test results:",
        list: [
    ...
    relatedLinks: [
      ...
      { href: "/en/guide/blood-test-price-bangkok", label: "All blood test prices Bangkok" },
      { href: "/en/guide/abnormal-results-bangkok-what-to-do", label: "Abnormal results — what to do" },
      { href: "/en/guide/ultrasound-scan-bangkok", label: "Abdominal ultrasound Bangkok (for fatty liver)" },
    ],
  },
  ...
  "thyroid-screening-bangkok": {
    ...
    relatedLinks: [
      { href: "/en/guide/blood-test-price-bangkok", label: "Blood test prices Bangkok" },
      { href: "/en/guide/vitamin-d-test-bangkok", label: "Vitamin D test Bangkok" },
      { href: "/en/guide/thyroid-nodule-bangkok", label: "Thyroid nodule found — what to do" },
      { href: "/en/guide/understanding-health-checkup-results", label: "Understanding your results" },
  ...
  "thyroid-nodule-bangkok": {
    ...
    sections: [
      ...
      {
        heading: "TI-RADS and risk categories — what your report means",
        content: "TI-RADS (Thyroid Imaging Reporting and Data System) classifies thyroid nodule ultrasound features:",
        list: [
      ...
      {
        heading: "FNAC biopsy in Bangkok — what to expect",
        content: "Fine needle aspiration cytology (FNAC / thyroid biopsy) procedure at Bangkok hospitals:",
        list: [
  ...
  "psa-test-bangkok": {
    ...
    relatedLinks: [
      { href: "/en/guide/mens-health-checkup-bangkok", label: "Men's health check-up guide" },
      { href: "/en/guide/prostate-health-check-bangkok", label: "Complete prostate health check Bangkok" },
      { href: "/en/guide/cancer-screening-bangkok", label: "Cancer screening Bangkok" },
      { href: "/en/guide/blood-test-price-bangkok", label: "All blood test prices" },
  ...
  "prostate-health-check-bangkok": {
    title: "Prostate Health Check Bangkok — PSA, MRI, Biopsy, Urologist Prices (2026)",
    description: "PSA ฿400–฿900. Prostate MRI (mpMRI) ฿15,000–฿25,000. TRUS biopsy ฿15,000–฿40,000. Urologist ฿1,500–฿3,000. What to do if PSA is elevated. Bangkok's JCI urologists explained.",
    intro: "Prostate cancer is the most common cancer in men over 60, and early detection through a prostate health check dramatically improves outcomes. A Bangkok executive health check-up typically includes a PSA blood test from age 45–50, but for men with an elevated PSA, family history of prostate cancer, or urinary symptoms, a more comprehensive prostate evaluation is needed. Bangkok's JCI-accredited hospitals have experienced urologists, multiparametric MRI (mpMRI) for non-invasive prostate tissue characterisation, and MRI-guided biopsy for targeted diagnosis — all at 40–60% below Western private rates. This guide covers the full prostate health evaluation pathway in Bangkok.",
    sections: [
      {
        heading: "Prostate health tests and prices in Bangkok (2026)",
        content: "Diagnostic tests for prostate health at Bangkok private hospitals:",
        list: [
      ...
      {
        heading: "Understanding your PSA result and what comes next",
        content: "How to interpret PSA results and navigate the prostate health pathway in Bangkok:",
        list: [
      ...
      {
        heading: "Prostate surgery and robotic treatment in Bangkok",
        content: "Treatment options if prostate cancer or significant BPH is found in Bangkok:",
        list: [
  ...
  "sti-hiv-test-bangkok": {
    ...
    relatedLinks: [
      ...
      { href: "/en/guide/blood-test-price-bangkok", label: "All blood test prices Bangkok" },
      { href: "/en/guide/travel-disease-tests-bangkok", label: "Travel infectious disease tests Bangkok" },
      { href: "/en/guide/mens-health-checkup-bangkok", label: "Men's health check-up guide" },
      { href: "/en/guide/health-checkup-expats-thailand", label: "Expat health check-up guide" },
      { href: "/en/guide/what-is-included-checkup", label: "What's included in each package tier" },
    ],
  ...
  "travel-disease-tests-bangkok": {
    title: "Travel Infectious Disease Tests Bangkok — Dengue, Typhoid, Malaria, Zika (2026)",
    description: "Got sick in Thailand? Dengue NS1/antibody test ฿400–฿800, typhoid antigen ฿500–฿1,000, malaria RDT ฿400–฿600, leptospirosis ฿600–฿1,200. Walk-in same day at Bangkok private hospitals.",
    intro: "Thailand's tropical climate, monsoon floods, and high tourist density create specific infectious disease risks that don't exist in most visitors' home countries. If you've developed a fever, rash, muscle aches, or unusual symptoms during or after a visit to Thailand, Bangkok's private hospitals offer fast, walk-in diagnostic testing for all tropical diseases. This guide covers what to test for, when, and what the results mean.",
    sections: [
      {
        heading: "Travel disease test prices in Bangkok",
        content: "Infectious disease blood test prices at Bangkok private hospitals (walk-in, 2026):",
        list: [
      ...
      {
        heading: "Symptom guide: what to test for in Bangkok",
        content: "Match your symptoms to the most likely disease and priority test:",
        list: [
      ...
      {
        heading: "Where to get tested and what to expect",
        content: "Practical guide for getting tested for tropical diseases in Bangkok:",
        list: [
  ...
  "cardiac-ct-calcium-score-bangkok": {
    ...
    description: "Coronary artery calcium (CAC) score: ฿4,000–฿8,000. CT coronary angiography (CTCA): ฿15,000–฿35,000. Cardiac CT finds silent heart disease before symptoms. Same-day results. No referral.",
    intro: "Coronary artery disease (CAD) causes heart attacks — and most people have no symptoms until a major cardiac event occurs. A coronary artery calcium (CAC) score CT scan is a simple 10-minute test that measures calcified plaque in the coronary arteries and accurately predicts heart attack risk 10–15 years in advance. In the USA and Europe, a CAC score costs $400–$1,500 and CT coronary angiography $2,000–$6,000. In Bangkok, the same tests cost ฿4,000–฿8,000 (CAC) and ฿15,000–฿35,000 (CTCA) — 60–80% less — with same-day results at JCI-accredited hospitals. This guide explains who should get a cardiac CT in Bangkok and what to expect.",
    sections: [
      {
        heading: "Cardiac CT prices in Bangkok (2026)",
        content: "Coronary artery calcium score and CT coronary angiography prices at Bangkok private hospitals:",
        list: [
      ...
      {
        heading: "Coronary calcium score — what it means",
        content: "Understanding your Agatston CAC score from a Bangkok cardiac CT:",
        list: [
      ...
      {
        heading: "Who should get a cardiac CT in Bangkok, and when",
        content: "Indications for cardiac CT at a Bangkok health check-up:",
        list: [
