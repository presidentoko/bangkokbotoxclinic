...
const GUIDES = [
  ...
  {
    slug: "health-checkup-argentina-vs-thailand",
    title: "Chequeo Médico: Argentina vs Tailandia — Bangkok para Argentinos (2026)",
    description: "Chequeo ejecutivo en Buenos Aires: USD 300–800. Bangkok: USD 320–675 — misma calidad JCI, resultados mismo día, sin lista de espera. Sin visa 30 días. Guía en español.",
    emoji: "🇦🇷",
    category: "By Nationality",
  },
  {
    slug: "gout-treatment-bangkok",
    title: "Gout & High Uric Acid Bangkok — Test, Treatment & Medication Costs (2026)",
    description: "Uric acid test ฿200–฿400. Allopurinol ฿30–฿150/month, febuxostat ฿300–฿900/month, colchicine for attacks. Rheumatologist same-day. What high uric acid means + what to do.",
    emoji: "🦶",
    category: "Understanding Your Check-Up",
  },
  {
  ...
  {
    slug: "health-checkup-pakistan-vs-thailand",
    title: "Health Check-Up: Pakistan vs Thailand 2026 — Bangkok for Pakistani Patients",
    description: "Pakistan private executive check-up PKR 50,000–150,000. Bangkok JCI: ฿8,000–฿25,000 ($215–$675) — 30–50% cheaper. JCI-accredited, English results, halal food, VOA for Pakistani passport.",
    emoji: "🇵🇰",
    category: "By Nationality",
  },
  {
    slug: "diabetes-management-bangkok",
    title: "Diabetes & High Blood Sugar Bangkok — Diagnosis, Medication & Management (2026)",
    description: "HbA1c ฿400–฿800. Metformin generic ฿60–฿300/month. Empagliflozin (Jardiance) ฿1,650–฿3,000/month. Insulin Lantus ฿600–฿1,200/vial. What high glucose means + what to do next.",
    emoji: "🩺",
    category: "Understanding Your Check-Up",
  },
  {
  ...
  {
    slug: "health-checkup-saudi-arabia-vs-thailand",
    title: "Health Check-Up: Saudi Arabia vs Thailand 2026 — Bangkok for Saudi Patients",
    description: "Saudi private hospital check-up SAR 3,000–12,000. Bangkok JCI: $320–$675 — 50–75% cheaper. No visa needed (since 2023). Riyadh–Bangkok direct 7.5 hrs. Arabic services. Halal.",
    emoji: "🇸🇦",
    category: "By Nationality",
  },
  {
...
export default async function GuidesPage({
  ...
  const hospitalCountLabel = Math.floor(stats.hospitalCount / 10) * 10;
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="mt-8 bg-blue-50 rounded-xl p-6">
        ...
        <p className="text-sm text-blue-700 mb-4">Browse all health check-up packages across Thailand with real prices from {hospitalCountLabel}+ hospitals.</p>
