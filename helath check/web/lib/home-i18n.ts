...
const en: HomeContent = {
  metaDescription: "Compare real health check-up prices from 235+ hospitals across 22 cities in Thailand. Bangkok, Chiang Mai, Phuket, Pattaya and more. No ads, no sponsored listings.",
  ...
  heroSubtitle: "Real prices scraped directly from hospital websites.",
  ...
  step1Title: "Browse real prices", step1Desc: "Our scrapers pull prices directly from hospital websites weekly. No mark-ups, no \"call for price\", no ads.",
...
const zh: HomeContent = {
  ...
  step1Title: "浏览真实价格", step1Desc: "我们的爬虫每周直接从医院官网抓取价格。无加价，无\"电话询价\"，无广告。",
...
const ja: HomeContent = {
  ...
  heroSubtitle: "病院の公式サイトから直接収集した実際の価格。",
  ...
  step1Title: "実際の価格を見る", step1Desc: "毎週、病院の公式サイトから直接価格を収集しています。上乗せ料金なし、「要問合せ」なし、広告なし。",
...
const th: HomeContent = {
  ...
  heroSubtitle: "ราคาจริงที่ดึงมาจากเว็บไซต์โรงพยาบาลโดยตรง",
  ...
  step1Title: "ดูราคาจริง", step1Desc: "ระบบของเราดึงราคาจากเว็บไซต์โรงพยาบาลโดยตรงทุกสัปดาห์ ไม่มีการบวกราคา ไม่มี \"โทรสอบถามราคา\" ไม่มีโฆษณา",
...
const ko: HomeContent = {
  ...
  heroSubtitle: "병원 공식 웹사이트에서 직접 수집한 실제 가격.",
  ...
  step1Title: "실제 가격 확인", step1Desc: "매주 병원 공식 웹사이트에서 직접 가격을 수집합니다. 추가 요금, \"전화 문의\", 광고가 없습니다.",
...
const ar: HomeContent = {
  ...
  heroSubtitle: "أسعار حقيقية مأخوذة مباشرة من مواقع المستشفيات.",
  ...
  step1Title: "تصفح الأسعار الحقيقية", step1Desc: "تجمع أدواتنا الأسعار مباشرة من مواقع المستشفيات أسبوعياً. بدون زيادة في السعر، وبدون \"اتصل للاستفسار عن السعر\"، وبدون إعلانات.",
