...
export default function GuideIndexPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <h1 className="text-4xl font-bold tracking-tight mb-3">Thailand Golf Guides</h1>
      <p className="text-base text-[var(--muted)] leading-relaxed mb-10 max-w-2xl">
        Practical, no-fluff guides written by editors who actually play in Thailand. No paid placements, no agency talking points — just what you need to know before you book.
      </p>
