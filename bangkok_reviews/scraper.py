...
def main():
    ...
    while not should_stop():
        ...
        _merge_and_save_features(out_dir / "restaurant_features.csv", all_features, existing_ids)
        _merge_and_save_hours(out_dir / "restaurant_hours.csv", all_hours, existing_ids)
