// Dynamic OG image — Next.js Image Response API. 모든 페이지의 og:image.
import { ImageResponse } from "next/og";
import { getSiteConfig } from "@/lib/site";

export const dynamic = "force-static";
export const alt = "Thai Supply Hub — Verified Manufacturers, Industrial Estates & Logistics";
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "auto" }}>
          ...
          <div style={{ fontSize: 28, fontWeight: 800, display: "flex" }}>
            <span>thai</span>
            <span style={{ color: cfg.themeAccent }}>supply</span>
            <span>hub</span>
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div style={{ fontSize: 26, color: "#525252", maxWidth: 1000 }}>
            {cfg.heroSub}
          </div>
        </div>
        ...
        <div style={{ display: "flex", gap: "24px", marginTop: "auto", color: "#737373", fontSize: 22 }}>
          ...
          <span>·</span>
          <span>Direct contact, no agent</span>
        </div>
      </div>
    ),
    size
