...
export class OpenVPNStaticKey {
    static parse(content: string): Buffer {
    ...
    static getHmacKey(keyBuffer: Buffer, direction: number): Buffer {
        // Key 0: 0-128
        // Key 1: 128-256
    ...
    static getHmacKeys(keyBuffer: Buffer, direction: number): { sendKey: Buffer, recvKey: Buffer } {
