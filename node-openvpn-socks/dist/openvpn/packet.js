...
exports.PacketParser = exports.Opcode = void 0;
exports.isControlOpcode = isControlOpcode;
...
var Opcode;
(function (Opcode) {
    Opcode[Opcode["P_CONTROL_HARD_RESET_CLIENT_V1"] = 1] = "P_CONTROL_HARD_RESET_CLIENT_V1";
    Opcode[Opcode["P_CONTROL_HARD_RESET_SERVER_V1"] = 2] = "P_CONTROL_HARD_RESET_SERVER_V1";
    Opcode[Opcode["P_CONTROL_SOFT_RESET_V1"] = 3] = "P_CONTROL_SOFT_RESET_V1";
    Opcode[Opcode["P_CONTROL_V1"] = 4] = "P_CONTROL_V1";
    Opcode[Opcode["P_ACK_V1"] = 5] = "P_ACK_V1";
    Opcode[Opcode["P_DATA_V1"] = 6] = "P_DATA_V1";
    Opcode[Opcode["P_CONTROL_HARD_RESET_CLIENT_V2"] = 7] = "P_CONTROL_HARD_RESET_CLIENT_V2";
    Opcode[Opcode["P_CONTROL_HARD_RESET_SERVER_V2"] = 8] = "P_CONTROL_HARD_RESET_SERVER_V2";
    Opcode[Opcode["P_DATA_V2"] = 9] = "P_DATA_V2";
    Opcode[Opcode["P_CONTROL_HARD_RESET_CLIENT_V3"] = 10] = "P_CONTROL_HARD_RESET_CLIENT_V3";
    Opcode[Opcode["P_CONTROL_WKC_V1"] = 11] = "P_CONTROL_WKC_V1";
    // NOTE: there is no P_CONTROL_HARD_RESET_SERVER_V3 — server always
    // replies with SERVER_V2 even to a V3 client reset.
    Opcode[Opcode["P_CONTROL_HARD_RESET_SERVER_V3"] = 8] = "P_CONTROL_HARD_RESET_SERVER_V3";
...
class PacketParser {
    ...
    static encode(packet) {
        ...
        const parts = [Buffer.from([opcodeByte])];
        if (packet.sessionId) {
        ...
        if (isControlOpcode(packet.opcode)) {
            ...
            if (packet.packetIdArray && nAcks > 0) {
                ...
                parts.push(buf);
                if (packet.remoteSessionId)
                    parts.push(packet.remoteSessionId);
            }
