...
const CITY_TH: Record<string, string> = {
  bangkok: 'กรุงเทพฯ', nonthaburi: 'นนทบุรี', samutprakan: 'สมุทรปราการ',
  chiangmai: 'เชียงใหม่', pattaya: 'พัทยา', phuket: 'ภูเก็ต',
}
    ...
    <main className="max-w-2xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <div className="text-sm text-gray-600 leading-relaxed space-y-2">
          ...
          <p>
            การค้นหาบนแผนที่คืนสถานที่ข้างเคียงมาด้วยเสมอ เราจึงคัดออก 121 รายการที่ไม่ใช่สถานพยาบาลสัตว์ —
            โรงพยาบาลคน โรงแรม ร้านอาบน้ำตัดขน ร้านขายอาหารสัตว์ ห้างสรรพสินค้า ไปจนถึงปั๊มน้ำมันและร้านกุญแจ
            รายการที่ถูกคัดออกจะไม่ปรากฏในหน้าไหนของเว็บและไม่ถูกส่งให้ Google จัดทำดัชนี
          </p>
          <p>
            <strong>ใบอนุญาตสถานพยาบาลสัตว์</strong> — จาก “รายชื่อสถานพยาบาลสัตว์ทั่วประเทศ” ของกรมปศุสัตว์
            ซึ่งระบุเลขที่และประเภทใบอนุญาต (รับสัตว์ป่วยค้างคืนได้หรือไม่) เราจับคู่กับคลินิกในฐานข้อมูลด้วยชื่อภาษาไทยและเขต/อำเภอ
            และจะไม่จับคู่เมื่อชื่อกำกวม คลินิกที่จับคู่ไม่ได้จึงไม่แสดงอะไร — ไม่ได้แปลว่าไม่มีใบอนุญาต
            เราไม่เผยแพร่ชื่อบุคคลที่ปรากฏในทะเบียน ·{' '}
            <a href="/hospital/license" className="text-orange-600 hover:underline">ค้นทะเบียน</a>
          </p>
          <p>
            <strong>อาหารสัตว์เลี้ยง</strong> — รายการสินค้าและส่วนประกอบมาจากเว็บไซต์ทางการของผู้ผลิตและร้านค้าปลีกที่แสดงฉลากสินค้า
