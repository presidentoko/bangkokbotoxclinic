...
export const metadata: Metadata = {
  title: 'Bottega Veneta vs Loewe Pre-Owned 2025 | SecondLuxuryItems',
  description: 'Bottega Veneta vs Loewe: comparing two quiet luxury giants pre-owned. Intrecciato vs Puzzle — which holds value better in 2025?',
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <h1 className="text-4xl text-[#1A1A1A] leading-tight mb-4" style={{ fontFamily: 'var(--font-playfair)' }}>
        Bottega Veneta vs Loewe Pre-Owned 2025
      </h1>
      <p className="text-[#8C7355] text-sm mb-10">Updated 2025 · Quiet luxury comparison</p>
