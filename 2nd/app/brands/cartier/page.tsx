...
export const metadata: Metadata = {
  title: 'Cartier Pre-Owned Price Guide 2025 | SecondLuxuryItems',
    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          '@type': 'ItemList',
          name: 'Pre-Owned Cartier Price Guide 2025',
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Pre-Owned Cartier Price Guide 2025</h1>
