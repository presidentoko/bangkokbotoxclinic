...
export const metadata: Metadata = {
  title: 'Chanel Pre-Owned Price Guide 2025 | SecondLuxuryItems',
...
export default function ChanelBrandPage() {
  ...
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'Pre-Owned Chanel Price Guide 2025',
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Pre-Owned Chanel Price Guide 2025</h1>
