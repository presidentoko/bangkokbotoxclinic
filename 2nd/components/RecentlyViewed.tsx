...
export function RecentlyViewed({ currentSlug }: { currentSlug: string }) {
  ...
  useEffect(() => {
    // Load existing
    try {
      const stored = JSON.parse(localStorage.getItem('sli_recent') || '[]') as RecentItem[]
  ...
  return (
    <section className="mt-10">
      <h2 className="text-base font-semibold text-gray-500 mb-3 uppercase tracking-wide">Recently Viewed</h2>
