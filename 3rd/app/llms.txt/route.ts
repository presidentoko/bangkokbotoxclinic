...
export function GET() {
  ...
  const lines = [
    ...
    '- https://www.chicpreowned.com/th/dealer-terms — the English shorthand Thai dealers write',
    '  listings in (Full Set, GHW, Holo, Microchip, WOC, Classic 10), defined in Thai, with the',
    '  number of listings each term was actually observed on',
