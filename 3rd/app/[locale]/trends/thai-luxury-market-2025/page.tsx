      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          {(isEn ? [
            ...
            { status: 'Hot', color: 'bg-amber-100 text-amber-800', name: 'Chanel Classic Flap (all sizes)', detail: 'Post-hike retail at ฿180–385k makes pre-owned at ฿95–280k the rational choice. Thai collectors keep local resale demand for Chanel strong.', thbRange: '฿95k–280k' },
            ...
            { status: 'ฮอต', color: 'bg-amber-100 text-amber-800', name: 'Chanel Classic Flap (ทุกขนาด)', detail: 'ราคาปลีกหลังขึ้นราคาที่ 180,000–385,000 บาท ทำให้มือสองที่ 95,000–280,000 บาท เป็นตัวเลือกที่สมเหตุสมผล นักสะสมชาวไทยทำให้ความต้องการ Chanel ในตลาดมือสองในประเทศยังคงแข็งแกร่ง', thbRange: '95,000–280,000 บาท' },
