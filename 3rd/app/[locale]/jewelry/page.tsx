...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: t('page_title_jewelry'),
    alternates: {
      canonical: `${BASE}/${locale}/jewelry`,
      languages: {
        en: `${BASE}/en/jewelry`,
        th: `${BASE}/th/jewelry`,
        'x-default': `${BASE}/en/jewelry`,
      },
    },
  }
}
  ...
  return (
    <>
      <h1 className="font-serif text-4xl text-[#1A1A1A] mb-3" style={{ fontFamily: 'var(--font-playfair)' }}>
        {t('page_title_jewelry')}
      </h1>
      <p className="text-[#6B6052] mb-2">{t('category_intro_jewelry')}</p>
