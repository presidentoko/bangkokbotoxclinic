...
export const alt = 'ราคากระเป๋าแบรนด์เนมมือสองในไทย'
    ...
    (
      <div style={{ background: '#0a0a0a', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '60px 72px', fontFamily: 'sans-serif' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ display: 'flex' }}>
            <div style={{ color: '#888', fontSize: '22px' }}>{isTH ? 'ราคากระเป๋ามือสอง' : 'Pre-Owned Handbag Prices Thailand'}</div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <div style={{ color: '#ffffff', fontSize: '52px', fontWeight: 700, lineHeight: 1.1, letterSpacing: '-1.5px' }}>{isTH ? 'กระเป๋าแบรนด์เนมมือสอง' : 'Used Designer Handbags'}</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ color: '#555', fontSize: '18px' }}>{isTH ? 'อัปเดตทุกสัปดาห์จากข้อมูลจริง' : 'Updated weekly from live listings'}</div>
