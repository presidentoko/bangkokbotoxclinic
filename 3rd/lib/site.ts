 ...
 * because the year was hardcoded across dozens of files; deriving it from the
 * newest `last_updated` in the dataset means the site rolls over the moment
 * the scraper does, and a stale year can only mean stale prices.
 */
